...
private:
    ...
    // Publisher for temperature messages
    rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr m_tempPub;
    ...
    static const inline std::string MODE_ABSOLUTE = "absolute";
    static const inline std::string MODE_RELATIVE = "relative";
    ...
    static constexpr auto SET_STREAMING_SLOTS_ROS_IMU_RELATIVE
    =":80,0,38,41,43,255,255,255,255\n";
    // 6 untarted quaternion
    static constexpr auto SET_STREAMING_SLOTS_ROS_IMU_ABSOLUTE
    =":80,6,38,41,43,255,255,255,255\n";
    ...
    static constexpr auto SET_STREAMING_SLOTS_ROS_IMU_ABSOLUTE_MAG
    =":80,6,38,41,40,255,255,255,255\n";
    // ----------------------------------------------------------------------------------------------------
