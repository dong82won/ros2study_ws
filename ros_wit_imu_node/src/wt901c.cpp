...
namespace wit_imu_driver
{
                           ...
                           const rclcpp::Time &stamp)
    {
        ...
        while (buf_.size() >= 11)
        {
            ...
            if (cs != buf_[10])
            {
                RCLCPP_WARN(rclcpp::get_logger("Wt901c"),
                            "[Wt901c] Checksum is not match. Rx : %02X, Calc : %02X",
                            buf_[10], cs);
                buf_.erase(buf_.cbegin());
                continue;
            }
            ...
            case 0x53:
            {
            ...
            }
                {
                    ...
                    temp_buf_.push_back(work_temp_);
